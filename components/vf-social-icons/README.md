...
# vf-social-icons Component

[![npm version](https://badge.fury.io/js/%40visual-framework%2Fvf-social-icons.svg)](https://badge.fury.io/js/%40visual-framework%2Fvf-social-icons)
...
This repository is distributed with [npm][https://www.npmjs.com/]. After [installing npm][https://www.npmjs.com/get-npm] and [yarn](https://classic.yarnpkg.com/en/docs/install), you can install `vf-social-icons` with this command.

```
$ yarn add --dev @visual-framework/vf-social-icons
```
...
```js
import { vfcomponentName } from 'vf-social-icons/vf-social-icons';
// Or import directly
// import { vfcomponentName } from '../components/raw/vf-social-icons/vf-social-icons.js';
...
```
@import "@visual-framework/vf-social-icons/index.scss";
```
