...
describe('VfHero Component', () => {
    ...
    test('renders with custom image and size', () => {
        render(
            <VfHero vf_hero_image="image.jpg" vf_hero_image_size="cover" />
        );
    ...
    //     render(
    //         <VfHero vf_hero_heading="Hero Heading" vf_hero_heading_href="https://example.com" />
    //     );
    //     const heading = screen.getByText('Hero Heading');
    //     const headingLink = within(heading).getByRole('link', { hidden: true });
    //     // const headingLink = within(heading).getByRole('link', { hidden: true });
    ...
    test('renders with link', () => {
        render(
            <VfHero vf_hero_link_text="Link Text" vf_hero_link_href="https://example.com" />
        );
    ...
    test('renders with additional heading', () => {
        render(
            <VfHero vf_hero_heading_additional="Additional Heading" />
        );
        expect(screen.getByText('Additional Heading')).toHaveClass('vf-hero__kicker');
    });
});