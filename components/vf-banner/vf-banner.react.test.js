...
describe('VfBanner Component', () => {
    ...
    test('renders dismissible basic banner', () => {
        render(<VfBanner banner__message="This is a dismissible banner" banner__dismissible={true} />);
        expect(screen.getByLabelText('close notification banner')).toBeInTheDocument();
    });

    test('renders inline banner with link', () => {
        render(<VfBanner banner__type="inline" banner__inline_href="http://example.com" />);
        ...
        const link = screen.getByRole('link', { name: /complete our quick survey/i });
    ...
    test('renders top banner with survey link', () => {
        render(<VfBanner banner__type="top" banner__inline_href="http://example.com" />);
        const element = screen.getByText('Complete our quick survey');
        expect(element).toBeInTheDocument();
