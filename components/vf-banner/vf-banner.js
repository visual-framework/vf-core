...
//     </p>
//
//     <button class="vf-button vf-text-button--2econdary">
...
function vfBannerInsert(banner,bannerId,scope) {
  ...
  if (banner.vfJsBannerButtonText && (banner.vfJsBannerState === 'blocking' || banner.vfJsBannerState === 'dismissible')) {
    generatedBannerHtml += '<button class="vf-button vf-text-button--2econdary" data-vf-js-banner-close>'+banner.vfJsBannerButtonText+'</button>';
  }
