...
import VfSidebarTemplate from "./vf-sidebar.precompiled.js"; // import templates before the nunjucks env
...
class VfSidebarCallback extends React.Component {
  componentDidMount() {
  ...
  variant, newTheme, card_image, card_text, card_image__alt, card_title
    ...
    return React.createElement(React.Fragment, null,
      React.createElement(Fragment, {
          ...
          __html: vfNunjucksEnv.render('vf-sidebar', {
      ...
      React.createElement(VfSidebarCallback, null)
    );
  }
);
