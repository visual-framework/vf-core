...
class VfChatbotActionPromptAngularModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "18.2.10", ngImport: i0, type: VfChatbotActionPromptAngularModule, declarations: [VfChatbotActionPromptAngularComponent], imports: [CommonModule], exports: [VfChatbotActionPromptAngularComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "18.2.10", ngImport: i0, type: VfChatbotActionPromptAngularModule, imports: [CommonModule] }); }
}
...
//# sourceMappingURL=visual-framework-vf-chatbot-action-prompt.angular.mjs.map
