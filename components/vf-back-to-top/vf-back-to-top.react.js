...
import VfBack-To-TopTemplate from "./vf-back-to-top.precompiled.js"; // import templates before the nunjucks env
...
class VfBack-To-TopCallback extends React.Component {
  componentDidMount() {
...
const VfBack-To-Top = React.memo(({
  variant, newTheme, card_image, card_text, card_image__alt, card_title
    ...
    return React.createElement(React.Fragment, null,
      React.createElement(Fragment, {
          ...
          __html: vfNunjucksEnv.render('vf-back-to-top', {
      ...
      React.createElement(VfBack-To-TopCallback, null)
    );
  }
);
