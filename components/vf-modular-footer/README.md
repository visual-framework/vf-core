...
[![npm version](https://badge.fury.io/js/%40visual-framework%2Fvf-modular-footer.svg)](https://badge.fury.io/js/%40visual-framework%2Fvf-modular-footer)

## About

The vf-modular-footer is a flexible footer component that allows websites to configure different modules based on their specific needs whilst maintaining consistent branding.

## Usage

### Description

The vf-modular-footer provides a flexible and structured approach to footer configuration. It allows configuration of specific sections and adjustment of text content as needed, while maintaining consistent layout, accessibility compliance, and brand identity.
...
This component is distributed with npm. After [installing npm](https://www.npmjs.com/get-npm), you can install the `vf-modular-footer` with this command.

```
$ yarn add --dev @visual-framework/vf-modular-footer
```
...
```
@import "@visual-framework/vf-modular-footer/index.scss";
```
