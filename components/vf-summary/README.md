...
The <code>vf-summary--has-decorative-image</code> variant has been <span style="color: rgb(228, 0, 70);">deprecated</span>. Please use the <a class="vf-link" href="/components/detail/vf-profile"><code>vf-summary--news-has-image</code></a> variant.
