...
const theoGeneratedFileWarning = `
// Do not edit directly: This file has been dynamically generated by
// \`gulp theo\` from the Visual Framwork \`vf-design-tokens\`
`;
const theoSourceTokenLocation = `
// Source: {{relative "${ patternPath }" meta.file}}

`;

const theoGeneratedSassTemplate = `
{{#each props as |prop|}}
  {{#if prop.comment}}
...
theo.registerFormat( "variables.scss",`${theoGeneratedFileWarning} ${theoSourceTokenLocation} ${theoGeneratedSassTemplate}`);
theo.registerFormat( "map.scss",`${theoGeneratedFileWarning} ${theoSourceTokenLocation} ${theoGeneratedSassTemplate}`);
theo.registerFormat( "custom-properties.scss",`${theoGeneratedFileWarning} ${theoSourceTokenLocation} :root {${theoGeneratedSassTemplate}}`);
