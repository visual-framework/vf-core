...
const theoGeneratedFileWarning = `// Do not edit directly: This file has been dynamically generated by
// \`gulp theo\` from the Visual Framwork \`vf-design-tokens\``;
const theoSourceTokenLocation = `// Source: {{relative "${ patternPath }" meta.file}}`;

const theoGeneratedPropertiesTemplate = `
${theoGeneratedFileWarning}
...
const theoGeneratedMapTemplate = `
${theoGeneratedFileWarning}
